            ...
            <div className="container mx-auto px-8 lg:flex">
              <div className="text-center lg:text-left lg:w-1/2">
                ...
                <p className="text-xl lg:text-2xl mt-6 font-light">
                  The one-stop to keep track of your favourite cryptocoins.
                </p>
              ...
              <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                <div className="flex-1 px-3">
                 ...
                 {" "}
                  ...
                  >
                    <p className="font-semibold text-xl"> Top15</p>
                    <p className="mt-4">
                    The best 15 performing cryptocoins in past 24 hours.
                    </p>
                  </div>
                  </Link>
                </div>
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                      Take a look at all trending cryptocoins.
                    </p>
                  </div>
                  </Link>
                </div>
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                      Keep track of all your favourite cryptocoins.
                    </p>
                  </div>
                  </Link>
                </div>
